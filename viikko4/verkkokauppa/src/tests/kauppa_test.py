...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kun_ostetaan_kaksi_eri_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kun_ostetaan_kaksi_samaa_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kun_ostetaan_yksi_oleva_tuote_ja_yksi_olematon_tuote(self):
    ...
    def test_aloita_asiointi_nollaa_edellisen_ostotapahtuman_tiedot(self):
    ...
    def test_kauppa_pyytaa_uuden_viitenumeron_jokaiselle_maksutapahtumalle(self):
        ...
        self.viitegeneraattori_mock.uusi.side_effect = [123, 234, 345]
    ...
    def test_varaston_palauta_varastoon_kutsutaan_kun_tuote_poistetaan_korista(self):
        ...
        # varmistetaan, että metodia on kutsuttu
